...
// ── DATA — Tự động tạo từ SteelTeam Config Editor ──────────────────────────
const USERS = [
  {
    "id": 1,
...
const TASKS = [
  {
    "id": 1,
    "project": 1,
    "title": "Tính toán momen uốn dầm B3",
    "assignee": 4,
    "priority": "high",
    "status": "inprogress",
    "due": "2024-07-10",
  ...
  },
  {
    "id": 2,
    "project": 1,
    "title": "Bản vẽ chi tiết liên kết cột-dầm",
    "assignee": 5,
    "priority": "high",
    "status": "review",
    "due": "2024-07-12",
...
const DOCS = [
  {
    "id": 1,
    "name": "TCVN 5575:2012 - Kết Cấu Thép",
    "category": "standard",
    "size": "4.2 MB",
    "updated": "2024-01-15",
    "project": null,
  ...
  {
    "id": 2,
    "name": "Template Bản Vẽ Chi Tiết v3.2",
    "category": "template",
    "size": "1.8 MB",
    "updated": "2024-05-20",
    "project": null,
  ...
  {
    "id": 3,
    "name": "Tính toán kết cấu BD-2024-01",
    "category": "project",
    "size": "2.1 MB",
    "updated": "2024-06-28",
    "project": 1,
  ...
  {
    "id": 5,
    "name": "Bản vẽ cầu LA-2024-02 Rev.3",
    "category": "project",
    "size": "12.4 MB",
    "updated": "2024-07-01",
    "project": 2,
...
const QUALITY_ISSUES = [
  {
    "id": 1,
    "project": 1,
    "title": "Sai chiều dày bản mã liên kết cột C12",
    "type": "error",
    "severity": "high",
    "status": "open",
    "reporter": 5,
  ...
  },
  {
    "id": 2,
    "project": 1,
    "title": "Thiếu gia cố tại lỗ khoét trên dầm",
    "type": "error",
    "severity": "critical",
    "status": "resolved",
    "reporter": 4,
  ...
  },
  {
    "id": 3,
    "project": 2,
    "title": "Đề xuất dùng HEA thay HEB để tối ưu TL",
    "type": "improvement",
    "severity": "low",
    "status": "pending",
    "reporter": 6,
  ...
  },
  {
    "id": 4,
    "project": 1,
    "title": "Sai chiều dày bản mã (tái phát)",
    "type": "error",
    "severity": "high",
    "status": "open",
    "reporter": 4,
...
const PLUGINS = [
  {
    "id": 1,
    "name": "GitHub Sync",
    "desc": "Tự động đồng bộ file thiết kế với GitHub repository",
    "icon": "⬡",
    "status": "connected",
    "category": "devops"
  },
  {
    "id": 2,
    "name": "Telegram Bot",
    "desc": "Thông báo task, deadline, lỗi qua Telegram channel",
    "icon": "✈",
    "status": "connected",
  ...
  },
  {
    "id": 3,
    "name": "API Tester",
    "desc": "Kiểm thử API kết nối với phần mềm tính toán bên ngoài",
    "icon": "⚡",
    "status": "available",
    "category": "testing"
  },
  {
    "id": 4,
    "name": "Docker Logs",
    "desc": "Theo dõi log container tính toán FEM tự động",
    "icon": "◈",
    "status": "available",
    "category": "devops"
  },
  {
    "id": 5,
    "name": "AutoCAD Bridge",
    "desc": "Xuất bản vẽ trực tiếp sang AutoCAD/Revit",
    "icon": "◉",
    "status": "available",
    "category": "cad"
  },
  {
    "id": 6,
    "name": "Excel Calc",
    "desc": "Nhập/xuất bảng tính kết cấu từ Excel tự động",
    "icon": "▦",
    "status": "connected",
    "category": "data"
  }
...
// ── PASSWORDS ────────────────────────────────────────────────────────────────
const USER_PASSWORDS = {1:"admin123", 2:"khoa123", 3:"hoa123", 4:"long123", 5:"mai123", 6:"tu123", 7:"admin123"};

// ── APP CONFIG ───────────────────────────────────────────────────────────────
// appName: "SteelTeam"  |  version: "v2.4.0"
// copyright: "JulyDragonVN"
// bgColor: "#060c18"  |  sidebarBg: "#070d1c"
// Dán đoạn này vào đầu file App.jsx, thay thế phần DATA cũ.
